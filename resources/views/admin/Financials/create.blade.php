...
@section('admin_content')
    <h1 class="h3 mb-3 text-gray-800">Add Financials</h1>

    <form action="{{ route('admin.financials.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 mt-2 font-weight-bold text-primary">Add Financials</h6>
                <div class="float-right d-inline">
                    <a href="{{ route('admin.financials.index') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> View All</a>
                </div>
            </div>
            <div class="card-body">

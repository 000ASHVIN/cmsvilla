...
@section('admin_content')
    <h1 class="h3 mb-3 text-gray-800">Add Case Study Items</h1>

    <form action="{{ route('admin.case.study.items.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 mt-2 font-weight-bold text-primary">Add Case Study Items</h6>

...
@section('admin_content')
    <h1 class="h3 mb-3 text-gray-800">Edit Industries Banner Page Information</h1>
            ...
            <div class="row">
                {{-- <div class="col-3">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <a class="nav-link" id="v-pills-6-tab" data-toggle="pill" href="#v-pills-6" role="tab" aria-controls="v-pills-6" aria-selected="false">Industries Banner</a>
                    </div>
                </div> --}}
                <div class="col-12">
                            ...
                            <form action="{{ url('admin/industry/banner/update/'.$industry->id) }}" method="post">
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 mt-2 font-weight-bold text-primary">Edit Industries Banner</h6>

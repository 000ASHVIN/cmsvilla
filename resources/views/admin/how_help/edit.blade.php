...
@section('admin_content')
    <h1 class="h3 mb-3 text-gray-800">Edit Industry Item</h1>

    <form action="{{ url('admin/how-help/update/'.$service->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 mt-2 font-weight-bold text-primary">Edit Industry Item</h6>

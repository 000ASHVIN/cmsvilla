      ...
      <div class="container">
        ...
        <div class="navbar-menu">
          ...
          <div class="navbar-start">
            ...
            <!-- Navbar item -->
            <a
              class="navbar-item is-slide ismobile-nav"
              href="./Industries.html"
            >
              Industries</a
            >
            <div class="dropdown">
              <a class="navbar-item is-slide" href="./Industries.html">
                Industries
              </a>

              <ul class="dropdown_menu">
                <a href="industrialusecaes.html"> <li>Restaurant Chains</li></a>
                <a href="industrialusecaes.html"><li>Ecommerce and D2C</li></a>
                <a href="industrialusecaes.html"><li>Financial Product Intermediaries</li></a>
              </ul>
            </div>
